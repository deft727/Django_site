...
class CategoryFeature(models.Model):
    ...
    category = models.ForeignKey("len_parfume.Category", verbose_name='Категория', on_delete=models.CASCADE)
...
class ProductFeatures(models.Model):
    ...
    product = models.ForeignKey("len_parfume.Product", verbose_name='Товар', on_delete=models.CASCADE)
